package org.example.occurrence.driven.order.demo.modules.idempotency.config;

import org.example.occurrence.driven.order.demo.modules.idempotency.filter.IdempotenceFilter;
...
public class IdempotencyConfig {
    ...
    @Value("${oddemo.idempotency.paths}")
    private List<String> idempotencyApiPaths;

    @Value("${oddemo.idempotency.ttlInMinutes:60}")
