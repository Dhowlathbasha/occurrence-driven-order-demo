package org.example.occurrence.driven.order.demo.command.payment.service;

import lombok.RequiredArgsConstructor;
import org.apache.commons.lang3.StringUtils;
import org.example.occurrence.driven.order.demo.command.payment.producer.PaymentEventProducer;
import org.example.occurrence.driven.order.demo.common.model.Payment;
import org.example.occurrence.driven.order.demo.event.model.PaymentEvent;
import org.example.occurrence.driven.order.demo.event.model.PaymentEventName;
import org.example.occurrence.driven.order.demo.observation.annotation.LogInfo;
import org.springframework.stereotype.Service;

import java.time.Instant;

import static org.example.occurrence.driven.order.demo.event.model.PaymentEventName.*;
