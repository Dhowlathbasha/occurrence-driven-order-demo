package org.example.occurrence.driven.order.demo.handler.payment.consumer;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.occurrence.driven.order.demo.event.model.PaymentEvent;
import org.example.occurrence.driven.order.demo.handler.payment.domain.PaymentEventHandler;
import org.springframework.kafka.annotation.KafkaListener;
import org.springframework.kafka.support.Acknowledgment;
import org.springframework.stereotype.Component;

import static org.example.occurrence.driven.order.demo.event.model.PaymentEvent.PAYMENT_EVENT_HANDLER_GROUP_ID;
