package org.example.occurrence.driven.order.demo.event.config;
...
import static org.example.occurrence.driven.order.demo.event.model.OrderEvent.*;
import static org.example.occurrence.driven.order.demo.event.model.PaymentEvent.PAYMENT_TOPIC;
import static org.example.occurrence.driven.order.demo.event.model.PaymentEvent.PAYMENT_TOPIC_PARTITION;
import static org.example.occurrence.driven.order.demo.event.model.ShipmentEvent.SHIPMENT_TOPIC;
import static org.example.occurrence.driven.order.demo.event.model.ShipmentEvent.SHIPMENT_TOPIC_PARTITION;
