package org.example.occurrence.driven.order.demo.command.order.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.occurrence.driven.order.demo.client.order.OrderQueryClient;
import org.example.occurrence.driven.order.demo.client.order.exception.ResourceNotFoundException;
import org.example.occurrence.driven.order.demo.client.order.model.V1Order;
import org.example.occurrence.driven.order.demo.client.order.model.V1OrderStatus;
import org.example.occurrence.driven.order.demo.command.order.producer.OrderEventProducer;
...
import static org.example.occurrence.driven.order.demo.event.model.OrderEventName.COMPLETED;
import static org.example.occurrence.driven.order.demo.event.model.OrderEventName.CREATED;
