package org.example.occurrence.driven.order.demo.query.order.domain.handler.impl;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.occurrence.driven.order.demo.event.model.OrderEvent;
import org.example.occurrence.driven.order.demo.observation.annotation.LogInfo;
import org.example.occurrence.driven.order.demo.query.order.domain.entity.OrderRecord;
import org.example.occurrence.driven.order.demo.query.order.domain.entity.OrderStatus;
import org.example.occurrence.driven.order.demo.query.order.domain.handler.OrderRecordHandler;
import org.example.occurrence.driven.order.demo.query.order.domain.repo.OrderRepository;
...
import static org.example.occurrence.driven.order.demo.query.order.domain.entity.OrderStatus.CREATED;
import static org.example.occurrence.driven.order.demo.query.order.domain.entity.OrderStatus.FINISHED;
